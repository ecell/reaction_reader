...
with reaction_rules:
    ...
    egfr(l,r) + egf(r) <_> egfr(l[1],r).egf(r[1]) | MassAction2(1.667e-06, .06)

    # Receptor-aggregation
    egfr(l[1],r) + egfr(l[2],r) <_> egfr(l[1],r[3]).egfr(l[2],r[3]) | MassAction2(5.556e-06, .1)
    ...
    # Y1068 activity
    egfr(Y1068(pY)) + Grb2(SH2,SH3) <_> egfr(Y1068(pY)[1]).Grb2(SH2[1],SH3) | MassAction2(8.333e-07, .05)
    egfr(Y1068(pY)) + Grb2(SH2,SH3[2]) <_> egfr(Y1068(pY)[1]).Grb2(SH2[1],SH3[2]) | MassAction2(1.25e-06, .03)
    egfr(Y1068(pY)[1]).Grb2(SH2[1],SH3) + Sos(dom) <_> egfr(Y1068(pY)[1]).Grb2(SH2[1],SH3[2]).Sos(dom[2]) | MassAction2(5.556e-06, .06)

    # Y1148 activity
    egfr(Y1148(pY)) + Shc(PTB,Y317(Y)) <_> egfr(Y1148(pY)[1]).Shc(PTB[1],Y317(Y)) | MassAction2(2.5e-05, .6)
    egfr(Y1148(pY)) + Shc(PTB,Y317(pY)) <_> egfr(Y1148(pY)[1]).Shc(PTB[1],Y317(pY)) | MassAction2(2.5e-07, .3)
    ...
    # Cytosolic
    Shc(PTB,Y317(pY)) + Grb2(SH2,SH3)    <_> Shc(PTB,Y317(pY)[1]).Grb2(SH2[1],SH3)    | MassAction2(1.667e-06, .01)
    Shc(PTB,Y317(pY)) + Grb2(SH2,SH3[2]) <_> Shc(PTB,Y317(pY)[1]).Grb2(SH2[1],SH3[2]) | MassAction2(1.167e-05, .1)
    Shc(PTB,Y317(pY)) > Shc(PTB,Y317(Y)) | MassAction(.005)
    Grb2(SH2,SH3) + Sos(dom) <_> Grb2(SH2,SH3[1]).Sos(dom[1]) | MassAction2(5.556e-08, .0015)
