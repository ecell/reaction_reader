...
#    NULL(d)
    ...
    GLU(C1(A0, A1),C2(A0, A1),C3(A0, A1),C4(A0, A1),C5(A0, A1),C6(A0, A1))
    G6P(C1(A0, A1),C2(A0, A1),C3(A0, A1),C4(A0, A1),C5(A0, A1),C6(A0, A1))
...
##    GLU(C1(0),C2(0),C3(0),C4(0),C5(0),C6(0)) [10]	
#    T3P(C1(0),C2(0),C3(0)) [0]	
#    ICIT(C1(0),C2(0),C3(0),C4(0),C5(0),C6(0)) [0]	
#    I(d) [1]	               #?????????                           
#    NULL(d) [0]	               #leak from the pathway??            


    GLU(C1(A0),C2(A0),C3(A0),C4(A0),C5(A0),C6(A0)) [10]	
