...
with reaction_rules:
    A(a) > B(b) [C(c)]            | 2.1 # [E]
    A(a) > B(b) [C(c).C(c)]       | 2.2 # [ES]
    A(a) > B(b) [C(c), C(c)]      | 2.3 # [E, E]
    A(a) > B(b) [C(c).C(c), C(c)] | 2.4 # [ES, E]
    A(a) > B(b) [C(c), C(c).C(c)] | 2.5 # [E, ES]

    A(a) > B(b)             [C(c)] | 1.1 # E [effector]
    A(a) > B(b).B(b)        [C(c)] | 1.2 # ES [effector]
    A(a) > B(b) + B(b).B(b) [C(c)] | 1.3 # ESL [effector]
    
    A(a)             + B(b).C(c) > D(d) | 0.1 # E + ES
    A(a).A(a)        + B(b).C(c) > D(d) | 0.2 # ES + ES
    A(a) + A(a).A(a) + B(b).C(c) > D(d) | 0.3 # ESL + ES
